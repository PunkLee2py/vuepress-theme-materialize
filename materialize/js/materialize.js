                    ...
                    value: function _handleCollapsibleClick(e) {
                        ...
                        if (e.target && $header.length) {
                            ...
                            if ($collapsible[0] === this.el) {
                                ...
                                var $collapsibleLis = $collapsible.children(
                                    "li"
                                );
                                var isActive = $collapsibleLi[0].classList.contains(
                                    "active"
                                );
                                var index = $collapsibleLis.index(
                                    $collapsibleLi
                                );
                ...
                },
                {
                    ...
                    value: function _animateIn(index) {
                        ...
                        if ($collapsibleLi.length) {
                            var $body = $collapsibleLi.children(
                                ".collapsible-body"
                            );
...
(function($, anim) {
    ...
    var Dropdown = (function(_Component2) {
        ...
        function Dropdown(el, options) {
            ...
            _this9._resetFilterQueryBound = _this9._resetFilterQuery.bind(
                _this9
            );
            ...
            [
                ...
                },
                {
                    ...
                    value: function _handleMouseLeave(e) {
                        ...
                        var leaveToDropdownContent = !!$(toEl).closest(
                            ".dropdown-content"
                        ).length;
                        var leaveToActiveDropdownTrigger = false;

                        var $closestTrigger = $(toEl).closest(
                            ".dropdown-trigger"
                        );
                        if (
                ...
                },
                {
                    ...
                    value: function _handleDropdownKeydown(e) {
                        if (e.which === M.keys.TAB) {
                            ...
                            var focusedElement = this.dropdownEl.children[
                                this.focusedIndex
                            ];
            ...
            [
                ...
                },
                {
                    ...
                    value: function _getAttributeOptions() {
                        ...
                        var tooltipTextOption = this.el.getAttribute(
                            "data-tooltip"
                        );
                        var positionOption = this.el.getAttribute(
                            "data-position"
                        );
                ...
                },
                {
                    ...
                    value: function _handleTriggerClick(e) {
                        ...
                        if (e.target && $trigger.length) {
                            ...
                            var sidenavInstance = document.getElementById(
                                sidenavId
                            ).M_Sidenav;
                            if (sidenavInstance) {
            ...
            [
                ...
                },
                {
                    ...
                    value: function _setupEventHandlers() {
                        ...
                        this._handleThrottledResizeBound = throttledResize.bind(
                            this
                        );
                        this._handleWindowScrollBound = this._handleWindowScroll.bind(
                            this
                ...
                },
                {
                    ...
                    value: function setHand(x, y, roundBy5) {
                        ...
                        if (isHours) {
                            ...
                            this[
                                "spanMinutes"
                            ].innerHTML = Timepicker._addLeadingZero(value);
                        }
